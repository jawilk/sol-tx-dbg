...
lldb::SBValueList *GetTopLevelScope(int64_t variablesReference) {
  cout << "GetTopLevelScope: " << variablesReference << endl;
  switch (variablesReference) {
  case VARREF_LOCALS: {
    cout << "GetTopLevelScope: VARREF_LOCALS" << endl;
